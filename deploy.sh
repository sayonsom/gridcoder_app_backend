...
kubectl create secret docker-registry regcred --docker-server=https://index.docker.io/v2/ --docker-username=sayonsync --docker-password=hejnUn-cyndup-putju5 --docker-email=sayon@syncenergyai.com